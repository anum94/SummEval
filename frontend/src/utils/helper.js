...
// Flatten an array of arrays into a single array using Array.prototype.concat():
export function flattenArray(list, key = 'children') {
  ...
  // Flatten an array with nested arrays of any depth
  ...
  // Orders an array of objects based on the properties and orders.
  ...
  // Sum the result of a function applied to each element in the array
